# Privacy Policy — Refactor Simulator

**Effective date:** 2026-08-04

Refactor Simulator is a Gap Hunter Labs plugin for IntelliJ Platform IDEs.
...
**Nothing.** Refactor Simulator does not collect, store, transmit, or sell
...
**None.** Refactor Simulator makes zero network calls during normal
...
None. Refactor Simulator has no third-party SDKs, no analytics libraries,
